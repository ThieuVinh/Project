...
export const content: Routes = [
    ...
    {
        path: 'nhaxuatban',
        loadChildren: () => import('../../pages/nhaxuatban/nhaxuatban.module').then(m => m.NhaxuatbanModule)
    },
    {
        path: 'bandoc',
    ...
    {
        path: 'phan-quyen',
        loadChildren: () => import('../../pages/phan-quyen/phan-quyen.module').then(m => m.PhanQuyenModule)
    },
];
